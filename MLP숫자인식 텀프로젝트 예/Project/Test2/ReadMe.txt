...
res\Toolbar.bmp
    ...
    초기 도구 모음과 상태 표시줄은 CMainFrame 클래스에서 생성됩니다. 이 도구 모음 비트맵을 리소스 편집기로 편집하고, Test2.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음 단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////
...
Test2Doc.h, Test2Doc.cpp - 문서
    이 파일에는 CTest2Doc 클래스가 포함됩니다. 이 파일을 편집하여 특수 문서 데이터를 추가하고 CTest2Doc::Serialize를 통해 파일 저장 및 로드를 구현합니다.

Test2View.h, Test2View.cpp - 문서 뷰
    이 파일에는 CTest2View 클래스가 포함됩니다.
    CTest2View 개체는 CTest2Doc 개체를 보는 데 사용됩니다.

res\Test2Doc.ico
    아이콘 파일이며, CTest2Doc 클래스 MDII 자식 창의 아이콘으로 사용됩니다. 이 아이콘은 기본 리소스 파일인 Test2.rc에 의해 포함됩니다.
